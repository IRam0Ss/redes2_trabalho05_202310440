...
public class TutorialOverlay extends Pane {
    ...
    public TutorialOverlay(StackPane root, List<TutorialStep> steps) {
        ...
        balloon = new VBox(15);
        balloon.setStyle("-fx-background-color: linear-gradient(to bottom right, rgba(229, 232, 215, 0.95), rgba(200, 210, 180, 0.95)); " +
    ...
    private void updateOverlay() {
        ...
        btnSkip.setStyle("-fx-background-color: transparent; -fx-text-fill: #5b6623; -fx-cursor: hand; -fx-font-family: 'Consolas'; -fx-font-weight: bold;");
        btnSkip.setOnAction(e -> end());

        Button btnNext = new Button(currentStepIndex == steps.size() - 1 ? "Concluir" : "Proximo ->");
        btnNext.setStyle("-fx-background-color: linear-gradient(to bottom, #4f5a2d, #3f4a23); -fx-text-fill: #d8e87d; -fx-padding: 8px 15px; -fx-background-radius: 20px; -fx-border-color: #5b6623; -fx-border-radius: 20px; -fx-border-width: 1px; -fx-cursor: hand; -fx-font-family: 'Consolas'; -fx-font-weight: bold;");
